...
func (a *JSONArray) AsBoolean() (bool, error) {
	return false, errors.ErrInvalidTypeWithDetails("boolean", "array")
}

// AsNumber 将值转换为数字
func (a *JSONArray) AsNumber() (float64, error) {
	return 0, errors.ErrInvalidTypeWithDetails("number", "array")
}
...
func (a *JSONArray) GetBoolean(index int) (bool, error) {
	value := a.Get(index)
	if value.IsNull() {
		return false, errors.ErrIndexOutOfRangeWithDetails(index, a.Size())
	}
...
func (a *JSONArray) GetNumber(index int) (float64, error) {
	value := a.Get(index)
	if value.IsNull() {
		return 0, errors.ErrIndexOutOfRangeWithDetails(index, a.Size())
	}
...
func (a *JSONArray) GetString(index int) (string, error) {
	value := a.Get(index)
	if value.IsNull() {
		return "", errors.ErrIndexOutOfRangeWithDetails(index, a.Size())
	}
...
func (a *JSONArray) GetArray(index int) (*JSONArray, error) {
	value := a.Get(index)
	if value.IsNull() {
		return nil, errors.ErrIndexOutOfRangeWithDetails(index, a.Size())
	}
